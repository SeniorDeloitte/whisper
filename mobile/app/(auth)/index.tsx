      ...
      <SafeAreaView className="flex-1">
        ...
        <View className="flex-1 justify-center items-center px-6">
          ...
          <View className="flex-row gap-4 mt-10">
            {/* GOOGLE BTN */}
            <Pressable
              className="flex-1 flex-row items-center justify-center gap-2 bg-white/95 py-4 rounded-2xl active:scale-[0.97] px-10"
              disabled={isLoading}
            ...
            {/* APPLE BTN */}
            <Pressable
              className="flex-1 flex-row items-center justify-center gap-2 bg-white/10 py-4 rounded-2xl border border-white/20 active:scale-[0.97] px-10"
              disabled={isLoading}
              accessibilityRole="button"
